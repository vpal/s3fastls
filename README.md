...
- **Customizable output**: Choose which S3 object fields to display (e.g., Key, Size, LastModified, ETag, StorageClass). The CLI writes TSV, and library callers can provide a custom formatter.
